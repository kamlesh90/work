...
public class EmployeeController {
    ...
    public ResponseEntity<List<Employee>> registerEmployees(@RequestBody List<Employee> listOfEmployees){
        List<Employee> savedListOfEmployee = employeeService.saveAll(listOfEmployees);
        ResponseEntity<List<Employee>> responseEntity = new ResponseEntity<>(savedListOfEmployee,HttpStatus.CREATED);
    ...
    public ResponseEntity<Resource> exportToExcel() throws IOException {
        ...
        ResponseEntity<Resource> body = ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + filename)//this piece of line means we have attachment file and name is this
